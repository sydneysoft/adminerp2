...
const dataForm = (empresa_id) => {
  ...
  <div class="text-left">
    ...
    <div class="form-group">
      ...
      <input id="nombre" class="form-control" placeholder="#{translation.FORM.CATEGORY_NAME}" />
    </div>
    <div class="form-group">
    ...
    <div class="mt-3">
      <button class="btn btn-primary btn-block" onclick="createItem(${empresa_id})">#{translation.FORM.SAVE}</button>
    </div>
  </div>
  `;
};
...
const updateData = (data) => {
  ...
  <div class="text-left">
    ...
    <div class="form-group">
      <label for="nombre">Nombre de la categoria</label>
      <input id="nombre" class="form-control" placeholder="#{translation.FORM.CATEGORY_NAME}" value="${data.nombre}" />
    </div>
    <div class="form-group">
      <label for="image">Imagen</label>
    ...
    <div class="form-group">
      <label for="descripcion">Descripción de la categoria</label>
      <textarea id="descripcion" class="form-control" placeholder="#{translation.FORM.CATEGORY_DESCRIPTION}">${data.descripcion}</textarea>
    </div>
    <div class="mt-3">

...
const dataForm = (data) => {
  return `
  <div class="text-left">
    <h2 class="text-center">#{translation.FORM.NEW_CATEGORY}</h2>
    <div id="alerta"></div>
    <div class="form-group">
      <label for="nombre">Nombre de la categoria</label>
      <input id="nombre" class="form-control" placeholder="#{translation.FORM.CATEGORY_NAME}" value="" />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea id="descripcion" class="form-control" placeholder="#{translation.FORM.CATEGORY_DESCRIPTION}"></textarea>
    </div>
    <div class="mt-3">
      <button class="btn btn-primary btn-block" onclick="createItem()">#{translation.SAVE}</button>
    </div>
  </div>
  `
};
...
const updateData = (data) => {
  ...
  <div class="text-left">
    ...
    <div class="form-group">
      <label for="nombre">Nombre de la categoria</label>
      <input id="nombre" class="form-control" placeholder="Nombre de la categoria" value="${data.nombre}" />
    </div>
    <div class="form-group">
      <label for="image">Imagen</label>
    ...
    <div class="form-group">
      <label for="descripcion">Descripción de la categoria</label>
      <textarea id="descripcion" class="form-control" placeholder="Descripción de la categoria">${data.descripcion}</textarea>
    </div>
    <div class="mt-3">
      <button class="btn btn-primary btn-block" onclick="updateCategory(${data.id})">#{translation.SAVE}</button>
    </div>
  </div>
  `;
}
...
const showData = (data) => {
  ...
  <div class="text-left">
    ...
    <div id="alerta"></div>
    <div class="form-group">
      <label for="nombre">#{translation.FORM.CATEGORY_NAME}</label>
    ...
    <div class="form-group">
      <label for="descripcion">#{translation.FORM.CATEGORY_DESCRIPTION}</label>
      <textarea id="descripcion" class="form-control" placeholder="#{translation.FORM.CATEGORY_DESCRIPTION}" readonly>${data.descripcion}</textarea>
    </div>
  </div>
  `;
}
